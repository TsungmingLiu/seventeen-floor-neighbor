...
>
> Existing accepted 1080×1920 objects remain valid runtime/provenance fixtures. Do not execute this recipe for new production.
...
>
> Canonical inputs: `docs/archive/art/PROTOTYPE_ART_REQUIREMENTS.md`, `docs/narrative/PROTOTYPE_BRAIDED_NARRATIVE_SPEC.md`, `docs/art/CHARACTER_REFERENCE_PACK_SPEC.md`.
>
