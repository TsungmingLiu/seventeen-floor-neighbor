...
>
> Historical backlog and copy-paste prompts. Current progress lives at `docs/narrative/CONTENT_PRODUCTION_TODO.md`; do not execute prompts from this file.

> Historical status: creative-production backlog
>
> 版本：0.3
>
> 更新：2026-09-24
...
> - `docs/archive/art/PROTOTYPE_ART_REQUIREMENTS.md` — inventory / broad intent only
> - `docs/archive/art/VERTICAL_SLICE_CG_GENERATION_PROMPTS.md` — historical shot intent; **禁止直接跑 batch prompt**
...
5. `docs/archive/art/PROTOTYPE_ART_REQUIREMENTS.md`
...
- `docs/narrative/PROTOTYPE_BRAIDED_NARRATIVE_SPEC.md`
- `docs/narrative/PROTOTYPE_ROUTE_GRAPH_AND_STATE.md`
- `docs/archive/art/PROTOTYPE_ART_REQUIREMENTS.md`
- setting proposal
