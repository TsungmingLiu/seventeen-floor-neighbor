...
> **DEPRECATED / FAILED PILOT. DO NOT RUN.** Use `.ai/experiments/pilots/tasks/COM00-S04-cg-artist-v0.2.md`. v0.1 allowed a nominal reference-fetch PASS without proving that actual image pixels were bound into generation.
...
allowed_sources:
  ...
  - .ai/experiments/pilots/data/COM00-S04/xu-tang.character.md
  - .ai/experiments/pilots/data/COM00-S04/bg-apt-17f-rain.environment.md
  - .ai/experiments/pilots/data/COM00-S04/COM00-S04.shot.md
...
inputs:
  ...
  character_packs:
    - .ai/experiments/pilots/data/COM00-S04/xu-tang.character.md
  environment_pack: .ai/experiments/pilots/data/COM00-S04/bg-apt-17f-rain.environment.md
  shot_pack: .ai/experiments/pilots/data/COM00-S04/COM00-S04.shot.md
...
deliverables:
  ...
  - id: com00-s04-preflight-v001
    destination: .ai/experiments/pilots/results/COM00-S04-cg-artist-preflight-v0.1.md
    requirement: >
