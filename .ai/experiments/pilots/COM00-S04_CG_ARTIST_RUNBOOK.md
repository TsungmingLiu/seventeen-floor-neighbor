...
> 按 repo 最新 AI production workflow，執行 `.ai/experiments/pilots/tasks/COM00-S04-cg-artist-v0.1.md`。嚴格遵守 source allowlist，只生成一張 candidate，不要自行重試或擴讀資料；先完成 preflight，再按 Task Packet 生圖。
