...
> 按 repo 最新 AI production workflow，執行 `.ai/pilots/tasks/COM-00-shot-planner-v0.1.md`。嚴格遵守 Task Packet 的 source allowlist，不要生圖；完成後把 deliverable 寫回 task 指定的位置並回報 handoff。
